            ...
            case Z3_OP_ANUM:
                ...
                if (expr.is_int() && expr.is_const()) {
                    ...
                    if (Z3_get_numeral_rational_int64(expr.ctx(), expr, &num, &den)) {
                        return manager.rational(storm::numbers::convertNumber<storm::RationalNumber>(static_cast<int_fast64_t>(num)) /
                                                storm::numbers::convertNumber<storm::RationalNumber>(static_cast<int_fast64_t>(den)));
                    } else {
                        return manager.rational(storm::numbers::convertNumber<storm::RationalNumber>(std::string(Z3_get_numeral_string(expr.ctx(), expr))));
                    }
                }
            case Z3_OP_AGNUM:
                ...
                return manager.rational(storm::numbers::convertNumber<storm::RationalNumber>(
