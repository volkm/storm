...
class FormulaVisitor {
   public:
    ...
    virtual boost::any visit(WeakUntilFormula const& f, boost::any const& data) const = 0;
    virtual boost::any visit(ReleaseFormula const& f, boost::any const& data) const = 0;
