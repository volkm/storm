...
template<>
std::pair<std::shared_ptr<storm::gspn::GSPN>, uint64_t> transformToGSPN(storm::dft::storage::DFT<double> const& dft, bool enableDC, bool extendPriorities,
    ...
    gspnTransformator.transform(priorities, dontCareElements, enableSmartTransformation, mergeDCFailed, extendPriorities);
...
template<>
std::pair<std::shared_ptr<storm::gspn::GSPN>, uint64_t> transformToGSPN(storm::dft::storage::DFT<storm::RationalFunction> const& dft, bool enableDC,
                                                                        bool extendPriorities, bool enableSmartTransformation, bool mergeDCFailed) {
...
std::pair<std::shared_ptr<storm::jani::Model>, std::vector<storm::jani::Property>> transformToJani(storm::gspn::GSPN const& gspn, uint64_t toplevelFailedPlace,
    ...
    if (addDeadlockProperties) {
        auto deadlockProperties = builder.getDeadlockProperties(model.get());
