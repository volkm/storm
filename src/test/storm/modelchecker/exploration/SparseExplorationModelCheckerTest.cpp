...
TEST_F(SparseExplorationModelCheckerTest, Dice) {
    ...
    storm::modelchecker::SparseExplorationModelChecker<storm::models::sparse::Mdp<double>, uint32_t> checker(env, program);
    ...
    EXPECT_NEAR(0.0277777612209320068, quantitativeResult1[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(0.0277777612209320068, quantitativeResult2[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(0.0555555224418640136, quantitativeResult3[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(0.0555555224418640136, quantitativeResult4[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(0.083333283662796020508, quantitativeResult5[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(0.083333283662796020508, quantitativeResult6[0], env.exploration().getPrecision());
}
...
TEST_F(SparseExplorationModelCheckerTest, AsynchronousLeader) {
    ...
    EXPECT_NEAR(1, quantitativeResult1[0], env.exploration().getPrecision());
    ...
    EXPECT_NEAR(1, quantitativeResult2[0], env.exploration().getPrecision());
}
...
TEST_F(SparseExplorationModelCheckerTest, Cicle) {
    ...
    EXPECT_NEAR(0.875, quantitativeResult1[0], env.exploration().getPrecision());
}
